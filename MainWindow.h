...
private slots:
    ...
    void on_renderArea_elementEdited(QPoint location, Qt::Orientation orientation);
    ...
    void on_renderArea_currentMeasured(QPoint location, Qt::Orientation orientation);
